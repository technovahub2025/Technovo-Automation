...
import { Phone, Mic, Settings, Users, BarChart3, Activity, PhoneCall, Bot } from 'lucide-react';
    ...
    <div className="voice-automation">
      ...
      <div className="voice-cards">
        ...
        <div className="voice-card">
          ...
          <button
            className="card-button"
            onClick={() => window.location.href = '/voice-automation/outbound'}
          >
            Make Call
          </button>
        </div>
        ...
        <div className="voice-card">
          ...
          <button
            className="card-button"
            onClick={() => window.location.href = '/voice-automation/flows'}
          >
            Create Flow
          </button>
        </div>
