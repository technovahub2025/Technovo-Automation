...
const OutboundCall = () => {
  ...
  const [callSettings, setCallSettings] = useState({
    ...
    maxDuration: 300,
    retryAttempts: 3,
    voice: 'ta-IN-PallaviNeural' // Use centralized default
  });
  ...
  const fetchCallHistory = async () => {
    try {
      const response = await apiService.getCallHistory({ limit: 10 });
  ...
  const fetchTemplates = async () => {
    try {
      ...
      setTemplates([
        { id: 'sales', name: 'Sales Pitch', description: 'Product introduction' },
        { id: 'support', name: 'Support Follow-up', description: 'Customer service call' },
        { id: 'reminder', name: 'Appointment Reminder', description: 'Reminder call' }
      ]);
    } catch (err) {
  ...
  const fetchScheduledCalls = async () => {
    try {
      ...
      setScheduledCalls([
        { id: '1', phoneNumber: '+1234567890', scheduleTime: '2024-01-25T10:00:00Z', status: 'scheduled' },
        { id: '2', phoneNumber: '+0987654321', scheduleTime: '2024-01-25T14:30:00Z', status: 'scheduled' }
      ]);
    } catch (err) {
