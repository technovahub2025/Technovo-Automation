...
export const metaAdsService = {
  async getCampaigns() {
    const response = await apiService.get("/api/meta-ads/campaigns");
    return response.data;
  },

  async getCampaignAdSets(campaignId) {
    const response = await apiService.get(`/api/meta-ads/campaign/${campaignId}/adsets`);
    return response.data;
  },

  async getAdSetAds(adSetId) {
    const response = await apiService.get(`/api/meta-ads/adset/${adSetId}/ads`);
    return response.data;
  },
  ...
  async createCampaignOnly(payload) {
    const response = await apiService.post("/api/meta-ads/campaign/create", payload);
    return response.data;
  },

  async createAdSet(payload) {
    const response = await apiService.post("/api/meta-ads/adset/create", payload);
    return response.data;
  },
  ...
  async createAd(payload, creativeFile) {
    ...
    const response = await apiService.post("/api/meta-ads/ad/create", formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    });
  ...
  async activateCampaign(payload) {
    const response = await apiService.post("/api/meta-ads/campaign/activate", payload);
    return response.data;
  },

  async activateAdSet(payload) {
    const response = await apiService.post("/api/meta-ads/adset/activate", payload);
    return response.data;
  },

  async activateAd(payload) {
    const response = await apiService.post("/api/meta-ads/ad/activate", payload);
    return response.data;
  },
